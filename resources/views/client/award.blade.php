...
<html lang="en">
    ...
    <section class="ftco-section ftco-project" id="projects-section">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
          	<span class="subheading">Scientific</span>
  ...
  <script>
	...
	async function createDiv(){
		div = document.getElementById("award")
		awards = await getAwards()
			...
			for (const i in awards) {
				...
				name.innerHTML = awards[i].title
				sponsor.innerHTML = awards[i].sponsor
				winners.innerHTML = "Joseph-Emmanuel Lee Chung Tom Hanks"
				name.style.color = "#ffd700"
				sponsor.style.color = "dark blue"
			
				
				sdiv.appendChild(name)
				sdiv.appendChild(sponsor)
				sdiv.appendChild(winners)
		...
		async function getAwards(){
			const response = await axios.get('api/awards').then(({ data }) => (awards = data.data ))
			return response	
		}
