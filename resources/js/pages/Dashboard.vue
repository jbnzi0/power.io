        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>3</h3> <!-- Data obtained from the DB -->
              ...
              <div class="card-body">
                <ul class="todo-list ui-sortable" data-widget="todo-list">
                  <li>
                    ...
                    <!-- todo text -->
                    <span class="text">Work on Powerio mock-up</span>
                    <!-- Emphasis label -->
                  ...
                  <li>
                    ...
                    <span class="text">Design the other pages</span>
                  ...
                  <li>
                    ...
                    <span class="text">Optimize Split codes</span>
                  ...
                  <li>
                    ...
                    <span class="text">Drink water</span>
                    <small class="badge badge-secondary"><i class="far fa-clock"></i> 1 min </small>
                    <div class="tools">
                      <i class="fas fa-edit"></i>
                      <i class="fas fa-trash-o"></i>
                    </div>
